...
echo "<br>------------------<br>";
echo "do while 循环语句：首先执行任务，执行任务完毕，判断某个条件是否符合，若符合则再次执行任务，执行完毕任务，继续判定条件。<br>";
$i = 1;
do{
	echo "在跑第".$i."圈。";
	$i++;
...
echo "<br>------------------<br>";
echo "循环结构之while与do...while语句的区别：while先判断条件是否成立，后执行循环，do...while先执行一次任务，再判断是否继续执行循环，也就是说do...while至少会执行一次任务。当条件为false时，while中的任务会一次也不执行，do...while中的任务会执行1次。<br>";
//A例子
$num = 2;
$su = 10;
while($nu >3){
